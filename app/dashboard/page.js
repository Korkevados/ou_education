    ...
    <div className="flex flex-col flex-1 h-full bg-sky-50">
      <div className="flex flex-col flex-1 h-full lg:min-h-[500px] lg:flex-row lg:h-[calc(100vh-16rem)] gap-4">
        ...
        <div className="lg:w-1/3 flex flex-col gap-4">
          ...
          <div className="lg:max-h-[45%] lg:h-[45%] flex flex-col">
            <h2 className="text-xl font-semibold mb-2 text-right">
              עקבו אחרינו ברשתות החברתיות
            </h2>
            <div className="grid grid-cols-2 gap-2 flex-1">
              {/* Facebook */}
              <div className="bg-white rounded-lg shadow-md p-2 flex flex-col justify-center items-center hover:shadow-lg transition-shadow">
                <a
                  href="https://www.facebook.com/ouyouthcenters"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 p-2 rounded-lg hover:bg-blue-50 transition-colors group w-full h-full justify-center">
              ...
              <div className="bg-white rounded-lg shadow-md p-2 flex flex-col justify-center items-center hover:shadow-lg transition-shadow">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 p-2 rounded-lg hover:bg-pink-50 transition-colors group w-full h-full justify-center">
                  ...
                  <span className="text-xs text-gray-700 group-hover:text-pink-600 text-center font-medium">
                    אינסטגרם
                  </span>
                </a>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-2 flex flex-col justify-center items-center hover:shadow-lg transition-shadow">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 p-2 rounded-lg hover:bg-red-50 transition-colors group w-full h-full justify-center">
                  ...
                  <span className="text-xs text-gray-700 group-hover:text-red-600 text-center font-medium">
                    יוטיוב
                  </span>
                </a>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-2 flex flex-col justify-center items-center hover:shadow-lg transition-shadow">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 p-2 rounded-lg hover:bg-black hover:text-white transition-colors group w-full h-full justify-center">
                  ...
                  <span className="text-xs text-gray-700 group-hover:text-white text-center font-medium">
                    טיקטוק
                  </span>
                </a>
              </div>
